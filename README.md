...
|Event Notifications API (TPP Endpoint sample)|- [Open API - Flattened JSON](./dist/openapi-flattened/event-notifications-openapi-flattened.json)<BR/>- [Open API - JSON](./dist/openapi-flattened/event-notifications-openapi-flattened.json)<BR/>- [Open API - YAML](./dist/openapi-flattened/event-notifications-openapi-flattened.json)<BR/>- [Swagger - Flattened JSON](./dist/swagger-flattened/event-notifications-swagger-flattened.json)<BR/>- [Swagger - JSON](./dist/swagger/event-notifications-swagger.json)<BR/>- [Swagger - YAML](./dist/swagger/event-notifications-swagger.yaml)|
